...
def reg_config(
        ...
        resumeit_set: bool = False, # DLM added features vvv 
        resumeit_clear: bool = False,
        low_speed_set: bool = False,
        low_speed_clear: bool = False,
        global_enable_set: bool = False,
        global_enable_clear: bool = False
    ) -> int:
    val = 0
    if pullup_set:
        val |= 0x00000001
    ...
    if low_speed_clear:
        val |= 0x00000080
    if global_enable_set:
        val |= 0x40000000
    if global_enable_clear:
        val |= 0x80000000
    return val
